This is a list of large primes expressed as sums of factorials I found using a simple algorithm run by Python in Colab, the primility is based on first round of probablistic Miller–Rabin Test, and then Lucas-Lehmer Test. (last updated on: Dec 29, 2022)
<p/>
